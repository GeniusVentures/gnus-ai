...
- [ ] **LIC-04**: Payment router facet — accepts GNUS-minions payment only (paid GNUS BURNED per D-10), producing License NFT creation/renewal + AI Credit minting/top-up. Off-chain operator fiat path (~$20 → GV buys GNUS → CREATOR_ROLE mint) per D-26. Payment asset and license/credit assets remain distinct. (amended 2026-08-25, D-26 — no USDC or fiat-onramp contract code)
