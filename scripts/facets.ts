...
export const Facets: FacetToDeployInfo = {
  ...
  GNUSNFTFactory: {
    priority: 40,
    versions: { 0.0: { deployInit: 'GNUSNFTFactory_Initialize' }, 2.0: { deployInit: 'GNUSNFTFactory_Initialize'} },
  },
  GNUSBridge: {
    priority: 50,
    versions: { 2.2: {} },
  },
  EscrowAIJob: { priority: 60, versions: { 0.0: { deployInit: 'EscrowAIJob_Initialize' } } },
