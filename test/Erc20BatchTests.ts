...
export async function suite() {
  ...
  it('Batch Transferring to two addresses', async () => {
    let balance = await (await gnusDiamond['balanceOf(address,uint256)'](owner.address, GNUS_TOKEN_ID)).toBigInt();
    ...
    balance = await (await gnusDiamond['balanceOf(address,uint256)'](owner.address, GNUS_TOKEN_ID)).toBigInt();
  ...
  it('Block Transfer Series', async () => {
    ...
    let receiverBalance = await (await gnusDiamond['balanceOf(address)'](receiver1.address)).toBigInt();
    await gnusDiamond.transfer(receiver1.address, toWei(10));
    receiverBalance = await (await gnusDiamond['balanceOf(address)'](receiver1.address)).toBigInt() ;
